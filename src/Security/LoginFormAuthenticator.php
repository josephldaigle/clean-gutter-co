...
/**
 * NOTE: This authenticator was Guard-based in Symfony <=5.3 and was ported
 * to the new authenticator system as part of the Symfony 6 upgrade. There is
 * no `login` route registered in this application, so `supports()` never
 * returns true in practice and this authenticator is effectively dormant.
 *
 ...
 * working before starts silently succeeding.
 */
